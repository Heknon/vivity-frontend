...
Widget buildPreviewImage(Uint8List image, {
  Size? size,
...
Widget buildItemCoupling(ItemModel modelLeft,
...
Widget buildItemContentGrid(List<ItemModel> items,
    Size itemViewSize,
    ScrollController sc, {
...
Widget buildDatabaseLikeButton(ItemModel item,
...
Widget buildCartItemList(List<CartItemModel> items,
    Size size,
    BuildContext context, {
      Size? itemSize,
      ...
      QuantityController? Function(BuildContext, CartItemModel)? quantityController,
  ...
  List<Widget> cartItems = List.generate(
    items.length,
        ...
        buildFunc(context, CartItem(
          ...
          quantityController: quantityController != null ? quantityController(context, items[i]) : null,
          borderRadius: itemBorderRadius,
          elevation: elevation,
